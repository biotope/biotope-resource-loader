(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  var mergeResources = function (resources) {
      ...
      return resources.reduce(function (aggregated, current) {
          ...
          return aggregated.concat([
              __assign({}, current, { dependencyPaths: uniq(unnest(resources.filter(function (r) { return r.path === current.path; }).map(function (r) { return r.dependencyPaths || []; }))) })
          ]);
      }, []);
  };

  var ComponentDefinitionBuilder = /** @class */ (function () {
      function ComponentDefinitionBuilder() {
          var _this = this;
          this.PATHS = [];
          this.BASE = '';
          this.DEPENDS_ON = [];
  ...
  var createComponentDefinition = function () { return new ComponentDefinitionBuilder(); };
  var getDefaultComponentDefinition = createComponentDefinition().build;
  ...
  var toResources = function (options, definition) {
      if (definition === void 0) { definition = getDefaultComponentDefinition(); }
  ...
  var ResourceLoader = /** @class */ (function () {
      ...
      ResourceLoader.prototype.logStatus = function () {
          console.log('Waiting ', this.waitingResources.slice());
          console.log('Pending ', this.pendingResources.slice());
          console.log('Loaded ', this.loadedResources.slice());
      };
